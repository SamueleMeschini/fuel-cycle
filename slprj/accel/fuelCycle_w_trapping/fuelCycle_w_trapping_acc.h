#ifndef RTW_HEADER_fuelCycle_w_trapping_acc_h_
#define RTW_HEADER_fuelCycle_w_trapping_acc_h_
#ifndef fuelCycle_w_trapping_acc_COMMON_INCLUDES_
#define fuelCycle_w_trapping_acc_COMMON_INCLUDES_
#include <stdlib.h>
...
real_T B_7_107_856 ; real_T B_7_108_864 ; real_T B_7_109_872 ; real_T
B_7_110_880 ; real_T B_7_111_888 ; real_T B_7_112_896 ; real_T B_7_113_904 ;
real_T B_7_114_912 ; real_T B_7_115_920 ; real_T B_7_116_928 ; real_T
B_7_117_936 ; real_T B_7_118_944 ; real_T B_7_119_952 ; real_T B_7_120_960 ;
real_T B_7_121_968 ; real_T B_7_122_976 ; } B_fuelCycle_w_trapping_T ;
typedef struct { real_T Memory_PreviousInput ; real_T Memory_PreviousInput_o
; real_T Memory_PreviousInput_b ; real_T Memory_PreviousInput_c ; real_T
...
AQHandles ; } _asyncqueue_inserted_for_ToWorkspace_PWORK_n ; struct { void *
...
int_T Last ; int_T CircularBufSize ; int_T MaxNewBufSize ; }
TransportDelay_IWORK_cs ; } DW_fuelCycle_w_trapping_T ; typedef struct {
...
Integrator_CSTATE_gf ; real_T Integrator_CSTATE_l ; real_T Integrator1_CSTATE
; } X_fuelCycle_w_trapping_T ; typedef struct { real_T Integrator_CSTATE ;
real_T integrator_CSTATE ; real_T integrator_CSTATE_p ; real_T
integrator_CSTATE_f ; real_T integrator_CSTATE_j ; real_T integrator_CSTATE_o
...
Integrator_CSTATE_c ; real_T Integrator_CSTATE_e ; real_T
Integrator_CSTATE_gf ; real_T Integrator_CSTATE_l ; real_T Integrator1_CSTATE
; } XDot_fuelCycle_w_trapping_T ; typedef struct { boolean_T
Integrator_CSTATE ; boolean_T integrator_CSTATE ; boolean_T
integrator_CSTATE_p ; boolean_T integrator_CSTATE_f ; boolean_T
...
Integrator_CSTATE_gf ; boolean_T Integrator_CSTATE_l ; boolean_T
Integrator1_CSTATE ; } XDis_fuelCycle_w_trapping_T ; typedef struct { real_T
...
Integrator_CSTATE_c ; real_T Integrator_CSTATE_e ; real_T
Integrator_CSTATE_gf ; real_T Integrator_CSTATE_l ; real_T Integrator1_CSTATE
; } CStateAbsTol_fuelCycle_w_trapping_T ; typedef struct { real_T
Integrator_CSTATE ; real_T integrator_CSTATE ; real_T integrator_CSTATE_p ;
real_T integrator_CSTATE_f ; real_T integrator_CSTATE_j ; real_T
integrator_CSTATE_o ; real_T integrator_CSTATE_l ; real_T integrator_CSTATE_h
; real_T Integrator_CSTATE_m ; real_T Integrator_CSTATE_f ; real_T
...
Integrator_CSTATE_c ; real_T Integrator_CSTATE_e ; real_T
Integrator_CSTATE_gf ; real_T Integrator_CSTATE_l ; real_T Integrator1_CSTATE
; } CXPtMin_fuelCycle_w_trapping_T ; typedef struct { real_T
Integrator_CSTATE ; real_T integrator_CSTATE ; real_T integrator_CSTATE_p ;
real_T integrator_CSTATE_f ; real_T integrator_CSTATE_j ; real_T
integrator_CSTATE_o ; real_T integrator_CSTATE_l ; real_T integrator_CSTATE_h
; real_T Integrator_CSTATE_m ; real_T Integrator_CSTATE_f ; real_T
...
Integrator_CSTATE_c ; real_T Integrator_CSTATE_e ; real_T
Integrator_CSTATE_gf ; real_T Integrator_CSTATE_l ; real_T Integrator1_CSTATE
; } CXPtMax_fuelCycle_w_trapping_T ; struct P_fuelCycle_w_trapping_T_ {
...
P_129 ; real_T P_130 ; } ; extern P_fuelCycle_w_trapping_T
fuelCycle_w_trapping_rtDefaultP ;
#endif
