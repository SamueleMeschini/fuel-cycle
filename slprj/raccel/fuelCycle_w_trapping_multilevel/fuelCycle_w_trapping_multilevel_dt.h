...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . iiiwxuggrg ) , 0 , 0 , 219 }
, { ( char_T * ) ( & rtDW . jbfemjfqdu ) , 0 , 0 , 5 } , { ( char_T * ) ( &
rtDW . b0dld00fnu ) , 15 , 0 , 5 } , { ( char_T * ) ( & rtDW . jxsf3xpnit .
LoggedData ) , 11 , 0 , 51 } , { ( char_T * ) ( & rtDW . gjpvvsicgx ) , 6 , 0
, 10 } } ; static DataTypeTransitionTable rtBTransTable = { 5U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . AF ) , 0 , 0 , 113 } } ; static DataTypeTransitionTable
