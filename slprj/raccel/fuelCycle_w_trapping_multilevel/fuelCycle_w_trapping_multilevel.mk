...
MODEL                   = fuelCycle_w_trapping_multilevel
MODULES                 = fuelCycle_w_trapping_multilevel.c fuelCycle_w_trapping_multilevel_capi.c fuelCycle_w_trapping_multilevel_data.c fuelCycle_w_trapping_multilevel_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = fuelCycle_w_trapping_multilevel
MAKEFILE                = fuelCycle_w_trapping_multilevel.mk
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/fuelCycle_w_trapping_multilevel \
